...
public class FormBiodataModel {
	...
	public FormBiodataModel() {

	}

	public FormBiodataModel(XBiodataModel biodataModel) {
		// biodata
		this.id = biodataModel.getId();
		this.fullname = biodataModel.getFullname();
		this.nickname = biodataModel.getNickname();
		this.pob = biodataModel.getPob();
		this.dob = biodataModel.getDob();
		this.gender = biodataModel.getGender();
		this.religionId = biodataModel.getReligionId();
		this.high = biodataModel.getHigh();
		this.weight = biodataModel.getWeight();
		this.nationality = biodataModel.getNationality();
		this.ethnic = biodataModel.getEthnic();
		this.hobby = biodataModel.getHobby();
		this.identityTypeId = biodataModel.getIdentityTypeId();
		this.identityNo = biodataModel.getIdentityNo();
		this.email = biodataModel.getEmail();
		this.phoneNumber1 = biodataModel.getPhoneNumber1();
		this.phoneNumber2 = biodataModel.getPhoneNumber2();
		this.parentPhoneNumber = biodataModel.getParentPhoneNumber();
		this.childSequence = biodataModel.getChildSequence();
		this.howManyBrothers = biodataModel.getHowManyBrothers();
		this.maritalStatusId = biodataModel.getMaritalStatusId();
		this.addrbookId = biodataModel.getAddrbookId();
		this.token = biodataModel.getToken();
		this.expiredToken = biodataModel.getExpiredToken();
		this.marriageYear = biodataModel.getMarriageYear();
		this.companyId = biodataModel.getCompanyId();
		this.isProcess = biodataModel.getIsProcess();
		this.isComplete = biodataModel.getIsComplete();
	}

	public FormBiodataModel(XAddressModel addressModel) {
		// address
		this.addressId = addressModel.getId();
		this.biodataId = addressModel.getBiodataId();
		this.address1 = addressModel.getAddress1();
		this.postalCode1 = addressModel.getPostalCode1();
		this.rt1 = addressModel.getRt1();
		this.rw1 = addressModel.getRw1();
		this.kelurahan1 = addressModel.getKelurahan1();
		this.kecamatan1 = addressModel.getKecamatan1();
		this.region1 = addressModel.getRegion1();
		this.address2 = addressModel.getAddress2();
		this.postalCode2 = addressModel.getPostalCode2();
		this.rt2 = addressModel.getRt2();
		this.rw2 = addressModel.getRw2();
		this.kecamatan2 = addressModel.getKecamatan2();
		this.kelurahan2 = addressModel.getKelurahan2();
		this.region2 = addressModel.getRegion2();
	}

	public void setAddressData(XAddressModel addressModel) {
		// address
		this.addressId = addressModel.getId();
		this.biodataId = addressModel.getBiodataId();
		this.address1 = addressModel.getAddress1();
